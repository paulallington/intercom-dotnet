...
namespace Intercom.Clients
{
    public class ContactsClient : Client
    {
        ...
        public Contact View(Contact contact)
        {
            ...
            else if (!String.IsNullOrEmpty(contact.external_id))
            {
                parameters.Add(Constants.USER_ID, contact.external_id);
        ...
        public Contacts Search(string field, string op, string value)
        {
            var body = new
            {
                query = new
            ...
            var result = Post<Contacts>(jsonBody, resource: CONTACTS_RESOURCE + Path.DirectorySeparatorChar + "search");
            return result.Result;
        }
        ...
        public User Convert(Contact contact)
        {
            ...
            if (String.IsNullOrEmpty(contact.id) && String.IsNullOrEmpty(contact.external_id))
            ...
            {
                contactBody.Add("user_id", contact.external_id);
            }
        ...
        public User Convert(Contact contact, User user)
        {
            ...
            {
                userBody.Add("user_id", user.external_id);
            }
            else
            {
